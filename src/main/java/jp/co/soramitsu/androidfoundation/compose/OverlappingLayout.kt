...
inline fun OverlappingLayout(
    ...
    Layout(
        ...
        measurePolicy = { measurables, constraints ->
            ...
            val width = if (overlappingAxis !== OverlappingAxis.Vertical) {
            ...
            val height = if (overlappingAxis !== OverlappingAxis.Horizontal) {
            ...
            layout(width, height) {
                ...
                for (placeable in placeables) {
                    ...
                    x += if (overlappingAxis !== OverlappingAxis.Vertical) {
                        (placeable.width * overlappingFactor).toInt()
                    } else {
                        0
                    }

                    y += if (overlappingAxis !== OverlappingAxis.Horizontal) {
